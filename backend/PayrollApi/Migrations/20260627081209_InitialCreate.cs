        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payrolls_PayrollMonths_PayrollMonthId",
                        column: x => x.PayrollMonthId,
                        principalTable: "PayrollMonths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWSEQUENTIALID()"),
                    EmployeeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TaxSlab = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaxConfigurations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSalaryStructures_EmployeeId_SalaryComponentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayrollMonths_Month_Year",
                table: "PayrollMonths",
                columns: new[] { "Month", "Year" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Payrolls_EmployeeId_PayrollMonthId",
                table: "Payrolls",
                columns: new[] { "EmployeeId", "PayrollMonthId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalaryComponents_Name",
                table: "SalaryComponents",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TaxConfigurations_EmployeeId",
